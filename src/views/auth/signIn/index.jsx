...
function SignIn() {
  // Chakra color mode
  const textColor = "gray.400"; //useColorModeValue("white.400", "white");
  ...
  return (
    <DefaultAuth image={image?.length > 0 && image[0]?.authImg}>
      <Flex
      ...
      >
        <Box me="auto">
          <Heading color="cyan.500" fontSize="36px" fontWeight="500" mb="10px">
            Sign In
          </Heading>
          <Text
            mb="36px"
